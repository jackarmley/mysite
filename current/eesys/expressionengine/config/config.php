...
$config['install_lock'] = "";
$config['license_number'] = "2193-8331-3223-1293";
$config['debug'] = '1';
$config['cp_url'] = "http://www.jackarmley.com/eesys/index.php";
$config['doc_url'] = "http://expressionengine.com/user_guide/";
$config['is_system_on'] = "n";
$config['site_label'] = 'Jack Armley';
...
/*Custom config (Added by Jack Armley)*/
$config['protect_javascript'] = FALSE;