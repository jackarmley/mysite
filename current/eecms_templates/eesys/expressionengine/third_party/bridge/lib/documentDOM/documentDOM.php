...
class documentDOM_bridge {
    ...
    {
    	$obj = new createElement_bridge($name, $attributes);
    	return $obj;
	}
	/* END */
...
class createElement_bridge extends documentDOM_bridge
{
	var $element	= '';
	...
	function createElement_bridge($name, $attributes = array())
	{
		if ($name == '') return;
