...
(function(window,undefined ) {
	var sitescripts = {
		ui:{
				...
				//Run icon insertion	
					if ($.browser.msie && browserver == 6 || browserver == 7){
						$(".app-ico").each(function(){
							...
							for(key in icons){
								if([key]==icon[1]){
									$(this).prepend("<span class='app-legacy_ico + icon[2]' style='font-family:SnowconeRegular;padding-right:0.5em;'>" + icons[key] + "</span>");
								};
							}
						});
					}
			...
			iemessage: function(){
     		...
     		ie8message: function(){
		          var iemessage = 
		          "<div id='gl-ie_message'>"+
		          "<p class='app-emphasised'><strong>Hey there! I notice you're using Internet Explorer version 8.</strong></p>"+
		          "<p>As I've decided to use new and shiny web&ndash;design techniques on my site, I've served you up a more basic set of styles. This is so I'm not hampered by IE8's incomplete support for modern webdesign techniques. You can of course, <a href='http://www.browserchoice.eu' title='Visit browser choice for the full selection of popular browsers'>upgrade or change your browser</a> if you wish but if not, feel free to enjoy the site.</p>"+
		          "</div>"
		          $("body").prepend(iemessage);
		    },
		...
		pagespecific:{
			...
			mepage: function(){
				var divider = "<div class='clear'></div>"
				$("#pg-me_instagram .app-plainlist li").eq(2)
					.addClass("lastitem")
					.after(divider);
			}
		},
    ...
    vendorspecific:{
      ie8: function(){
        $("#pg-me_instagram li:last-child").addClass("lastitem");
      },
      oldie: function(){
        $(".app-grid_listing img").attr("height","260");
      }
    }
	} 
...
$(document).ready(function() {
	//Remove noscript tag from <html> element
	...
	//section specific
		...
		if(section=="pg-me"){
			sitescripts.pagespecific.mepage()
		}
	...
	if(subpage_classstack[1]=="oldie"){
      ...
      sitescripts.vendorspecific.oldie()
	}
    if(subpage_classstack[1]=="ie8"){
      sitescripts.ui.ie8message()
      if(section=="pg-me"){
        sitescripts.vendorspecific.ie8()
      }
    }
